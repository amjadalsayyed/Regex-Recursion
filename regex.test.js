...
function ioEmail(email) {
  // Add your logic.
  let pattern = /^[a-zA-Z0-9]+@[a-zA-Z]+.io$/;
...
function imagesSearcher(text) {
  let arr = [];
  let pattern1 = /^[a-zA-Z]+.png$/;
  let pattern2 = /^[a-zA-Z]+.jpeg$/;
  let pattern3 = /^[a-zA-Z]+.jpg$/;

  arr = text
    .split(" ")
    .filter((e) => pattern1.test(e) || pattern2.test(e) || pattern3.test(e));
